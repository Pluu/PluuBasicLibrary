 ...
 */
public class StringAdapter extends NormalAdapter {
	public StringAdapter(Context context, List<ResourceInfo> list) {
		super(context, list);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		value.setText(String.valueOf(res.getString(item.getId())));
